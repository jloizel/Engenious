          ...
          <div className={styles.aboutBox}>
            ...
            <div className={styles.textContainer}>
              ...
              <div className={styles.text}>
                ...
                <span>We understand that every individual and organisation is unique, which is why we take a personalised approach to recruitment. By truly understanding the needs, goals, and aspirations of our clients and candidates, we ensure that every match is not just a transaction, but a transformative partnership.</span> 
